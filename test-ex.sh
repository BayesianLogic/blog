...
for CLASS in test.example.TestPoissonBall test.example.TestSimpleAircraft test.example.TestHurricane test.example.TestBurglary test.example.TestWeather
do
