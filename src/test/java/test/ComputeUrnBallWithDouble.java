...
public class ComputeUrnBallWithDouble {
	...
	public static void main(String[] args) {
		...
		ComputeUrnBallWithDouble cp = new ComputeUrnBallWithDouble();
		double[] probN = cp.compute(obs);
		System.out.println("Uniform prior:");
		print(probN);

		ComputeUrnBallWithDouble cp_poisson = new ComputeUrnBallWithDouble(6.0);
	...
	public ComputeUrnBallWithDouble() {
		// use uniform
	}

	public ComputeUrnBallWithDouble(boolean usePoisson) {
	...
	public ComputeUrnBallWithDouble(double lambda) {
