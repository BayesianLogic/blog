...
public class TestFixed extends TestParse {
  ...
  public void testFixedConstantDeclaration() {
    {
      ...
      String generated = toRepr(Stmts(new FixedFuncDec(Symbol("a"),
          Type(Symbol("Real")), Expr(1.0))));
      assertEquals(generated, parsed);
    }
    {
      String parsed = parseToRepr("fixed Boolean a = true;");
      String generated = toRepr(Stmts(new FixedFuncDec(Symbol("a"),
          Type(Symbol("Boolean")), Expr(true))));
      assertEquals(generated, parsed);
    }
  }
  ...
  public void testFixedConstantWithExpr() {
    ...
    String generated = toRepr(Stmts(new FixedFuncDec(Symbol("a"),
        Type(Symbol("Real")), Expr(OpExpr.PLUS, Expr(1.0), Expr(Symbol("b"))))));
    assertEquals(generated, parsed);
  }
  ...
  public void testDistinct() {
    ...
    String generated = toRepr(Stmts(new DistinctSymbolDec(Type(Symbol("Real")),
  ...
  public void testFixedFunction() {
    ...
    String generated = toRepr(Stmts(new FixedFuncDec(Symbol("add"), Fields(
        Field(Symbol("a"), Type(Symbol("Real"))),
        Field(Symbol("b"), Type(Symbol("Real")))), Type(Symbol("Real")), Expr(
        OpExpr.PLUS, Expr(Symbol("a")), Expr(Symbol("b"))))));
    assertEquals(generated, parsed);
  }
