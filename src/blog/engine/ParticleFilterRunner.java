 ...
 * provide at each step. A method {@link #moveOn()} obtains evidence and queries
 * from methods {@link #getEvidence(Model)} and {@link #getQueries(Model)}
 * respectively. If either of these methods returns <code>null</code>, execution
 * stops and {@link #moveOn()} returns <code>false</code>. Otherwise it returns
 * <code>true</code> and waits for the next call. The class is meant as a base
 * class to be extended by classes providing specialized evidence and queries
 * appropriate to particular types of models.
 * 
 * @author Rodrigo
 */
public abstract class ParticleFilterRunner {
	...
	public boolean moveOn() {
		...
		if ((evidence = getEvidence()) != null && (queries = getQueries()) != null) {
	...
	/**
	 * Method called before evidence and queries are collected; does nothing by
	 * default.
	 */
	...
	/**
	 * Method called after evidence and queries are collected; does nothing by
	 * default.
	 */
	...
	/**
	 * Provides evidence for each step of {@link #moveOn()}; it ends the process
	 * if it returns <code>null</code>.
	 */
	public abstract Evidence getEvidence();

	/**
	 * Provides queries for each step of {@link #moveOn()}; it ends the process if
