...
/** 
 * Grouping class for a model, evidence and queries,
 * link string (see {@link TemporalEvidenceGenerator})
 * and a query template (see {@link TemporalQueriesInstantiator}),
 * used in {@link DBLOGExperiments}.
 */ 
class Problem {
    ...
    /**
     * Builds problem from String descriptions. Note that <code>queryString</code> must describe a single query only.
     */
    public Problem(String modelDescription, String evidenceString, String queryString, Collection linkStrings, String queryTemplate) {
    ...
    /**
     * Same as {@link #Problem(String, String, String, Collection, String)}, but accepting a normalizer (for the query) as well.
     */
    public Problem(String modelDescription, String evidenceString, String queryString, Collection linkStrings, String queryTemplate, UnaryFunction normalizer) {
	this(modelDescription, evidenceString, queryString, linkStrings, queryTemplate);
    ...
    /** Convenience method assuming there is only one query, of class ArgSpecQuery, and returning it, or null if there aren't any queries. */
	...
	ArgSpecQuery result = TemporalQueriesInstantiator.getQuery(queryTemplate, t, model);
	if (normalizer != null) {
