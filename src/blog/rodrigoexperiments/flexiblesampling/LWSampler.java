...
public class LWSampler extends Sampler {
	...
	BLOGUtil.setBasicVars(evidence, currentWorld);
        ...
        context =
            new EvalContext(
        	    currentWorld, Util.set(), flexibleImportanceSamplerFactory);
	...
	// TODO: OPTIMIZATION: if a evidence variable's parents are evidence variables themselves, their probability can be factored out from here.
	// Also, this can be cached in case getLatestWeight gets called more than once in between samples. 
    }
