...
public class Print {
	...
	public void prExp(Expr e, int d) {
		...
		if (e instanceof OpExpr)
			...
			prExp((StringExpr) e, d);
		else if (e instanceof BooleanExpr)
			prExp((BooleanExpr) e, d);
		else if (e instanceof FuncCallExpr)
			prExp((FuncCallExpr) e, d);
		else if (e instanceof IfExpr)
			prExp((IfExpr) e, d);
		else if (e instanceof ListInitExpr)
			prExp((ListInitExpr) e, d);
		else if (e instanceof ExplicitSetExpr)
			prExp((ExplicitSetExpr) e, d);
		else if (e instanceof ImplicitSetExpr)
			prExp((ImplicitSetExpr) e, d);
		else if (e instanceof DistributionExpr)
			prExp((DistributionExpr) e, d);
		else
