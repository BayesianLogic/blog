...
public class FormulaLikelihoodTest extends TestCase {
	...
	"" +
	"random Boolean Sunny;" +
	"Sunny = true;" +
	"" +
	"random Boolean Windy;" +
	"Windy = true;" +
	"" +
	"random Blip B1;" +
    ...
    private static void checkAreMutuallyExclusiveLiteralsGivenIndependence(Object[] test, Model model) {
	...
	Formula literal0 = (Formula) BLOGUtil.parseLiteral_NE(literalString0, model);
	Formula literal1 = (Formula) BLOGUtil.parseLiteral_NE(literalString1, model);
	boolean result;
	...
	Object[][] tests = {
		...
		{"(Sunny & ApparentPos(b) = 3) | (Sunny & ApparentPos(b) = 3) | (Sunny & ApparentPos(b) = 4)", false},
		{"(Sunny & ApparentPos(b) = 3) | (Sunny & ApparentPos(b) = 4) | (Sunny & ApparentPos(b) = 5)", true},
		{"Sunny & ApparentPos(b) = 3 | Sunny", false},
    ...
    private static void checkIsDNFWithMutuallyExclusiveDisjunctsGivenIndependence(Object[] test, Model model) {
