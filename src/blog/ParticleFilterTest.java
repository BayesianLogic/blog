...
public class ParticleFilterTest extends TestCase {
    ...
    private static final String symbolEvidenceModelString =
	"type Aircraft;" +
...
//    }
	...
	assertEquals(expected, BLOGUtil.getProbabilityByString(getQuery(meq.queries), model, valueString), delta);
