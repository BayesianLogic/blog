...
/**
 * A UnaryFunction receiving a {@link DependencyAwareEnvironment} object.
 * This allows the user to write an <code>evaluate</code> method taking an already typed parameter,
 * avoiding a cast.
 * @author Rodrigo
 */
