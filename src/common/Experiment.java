...
public class Experiment {
    ...
    public static String[] basicPreCommands = {
     ...
     * Arguments can be provided in any order, although the order of range operation does matter. 
     */ 
...
//	PreCommands preCommands = getPreCommands(args);
	...
	if (ySeriesAxis != null) {
	    ...
	    if (axes.size() > 1) {
		Util.fatalError("YSeriesSpec " + seriesSpec + " does not refer to any present axis and data is multidimensional.");
	    }
