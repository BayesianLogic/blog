...
public class Distance {
    ...
    /**
     * Makes a distance matrix (row and columns refer to the order of the given set's iterators.
     */
    ...
    /**
     * Calculates the exact distance from two sets,
     * which is the average of the distances over all matchings.
     */
	...
	double sum = 0;
	PermutationIterator permutationIt = new PermutationIterator(s1.size(), s2.size());
    ...
    /**
     * Returns the weighted average of a given object's distances to a weighted set.
     */
    ...
    /**
     * Returns the weighted average of a collection's objects' weighted average distances to another set.
     */
    public double distance(Collection c1, UnaryFunction weight1, Collection c2, UnaryFunction weight2) {
	double sum = 0;
	double sumOfWeights = 0;
	for (Object o1 : c1) {
