...
public class RangeOperations {
    ...
    public RangeOperations(DependencyAwareEnvironment environment, List<? extends RangeOperation> rangeOperations, DAEFunction function) {
    ...
    /**
     * A range must be a {@link NullaryFunction} producing a new iterator,
     * keep a {@link DependencyAwareEnvironment}
     * set by {@link #setEnvironment(DependencyAwareEnvironment)}
     * that is updated by its method {@link #next()},
     * and receive {@link BinaryProcedure} listeners to be called
	...
	public PredicatedAveraging(String name, UnaryPredicate predicate, final int first, final int last, final int step) {
	    super(new PredicatedAverage(predicate), new IntegerRange(name, first, last));
	}
	public PredicatedAveraging(String name, UnaryPredicate predicate, final int first, final int last) {
    ...
    public static PredicatedAveraging PredicatedAveraging(String name, UnaryPredicate predicate, int first, int last) {
