...
class BlogLexer(RegexLexer):
    ...
    filenames = ['*.blog']
    operators = ['=','~',':']
    keywords = ['extern','import','fixed','func','distinct','random','origin','param']
    types = ['Int','Real','Boolean','NaturalNum','List','Map','TabularCPD','Categorical','Distribution','Gaussian','type']
