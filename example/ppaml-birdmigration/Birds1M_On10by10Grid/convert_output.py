...
def output_reconstruction(blog_data):
    ...
    """
    with open('../cps/dataset3/10x10x1000-train-reconstruction.csv', 'w') as csv_file:
...
def output_prediction(blog_data):
    ...
    """
    with open('../cps/dataset3/10x10x1000-test-prediction.csv', 'w') as csv_file:
        writer = csv.writer(csv_file)
        writer.writerow(
...
def output_estimation(blog_data):
    ...
    """
    with open('../cps/dataset3/estimated-parameters.csv', 'w') as csv_file:
        writer = csv.writer(csv_file)
