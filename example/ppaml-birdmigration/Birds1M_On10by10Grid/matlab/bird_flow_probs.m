...
fprintf(fid,'random Real beta1 ~ UniformReal(3, 13); \n');
fprintf(fid,'random Real beta2 ~ UniformReal(3, 13); \n');
fprintf(fid,'random Real beta3 ~ UniformReal(3, 13); \n');
fprintf(fid,'random Real beta4 ~ UniformReal(3, 13); \n');
